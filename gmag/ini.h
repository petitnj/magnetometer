#ifndef _INIFILE__H
#define _INIFILE__H
//#endif //moving #endif to the end of header so that ini library will work in standard way.(pcruce 2013-02-06)
...
#endif //moved #endif to the end of header so that ini library will work in standard way.(pcruce 2013-02-06)
